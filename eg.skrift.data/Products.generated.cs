...
#pragma warning restore 0109
		...
		{
			get { return eg.skrift.data.ContentBase.GetBodyText(this); }
		}
		...
		{
			get { return eg.skrift.data.ContentBase.GetPageTitle(this); }
		}
		...
		{
			get { return eg.skrift.data.NavigationBase.GetKeywords(this); }
		}
		...
		{
			get { return eg.skrift.data.NavigationBase.GetSeoMetaDescription(this); }
		}
		...
		{
			get { return eg.skrift.data.NavigationBase.GetUmbracoNavihide(this); }
		}
	}
}
